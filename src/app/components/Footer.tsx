      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-6 md:mb-0">
            <h2 className="text-lg font-bold text-gray-200">Abhay Kaushal</h2>
            <p className="text-gray-400">Building digital experiences with creativity and code.</p>
            <div className="flex space-x-4 mt-4">
              {/* LinkedIn Icon */}
              <Link href="www.linkedin.com/in/abhay-kaushal-0a653525a" target="_blank" rel="noopener noreferrer">
              ...
              {/* GitHub Icon */}
              <Link href="https://github.com/Dazzler1234" target="_blank" rel="noopener noreferrer">
                <svg className="w-6 h-6 text-gray-400 hover:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Facebook Icon */}
              <Link href="https://www.facebook.com/suraj.kaushal.142035" target="_blank" rel="noopener noreferrer">
                <svg className="w-6 h-6 text-gray-400 hover:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="font-semibold text-gray-200">abhaykaushal920@gmail.com</p>
            <p className="font-semibold text-gray-200">+91 7235853489</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6">
          <p className="text-center text-sm text-gray-400">
            © {new Date().getFullYear()} Abhay kaushal. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
